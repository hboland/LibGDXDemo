...
public class World2_Level5 implements Level {
    ...
    public World2_Level5(){

        walkingTextureAtlas = new TextureAtlas("realistic emu walk.txt");
        textureAtlas = new TextureAtlas("World2_level5.txt");

        jimmyName = "realistic emu";
        jimmyAttackName = "realistic emu attack";
        jimmyAbsorbName = "realistic emu absorb";
        background = "realistic background";

        walkingAnimation = new Animation<TextureRegion>(0.1f, walkingTextureAtlas.getRegions());
        evolveSheet = new Texture(Gdx.files.internal("car evolution.png"));
