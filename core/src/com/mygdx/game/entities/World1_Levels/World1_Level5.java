...
public class World1_Level5 implements Level {
    ...
    public World1_Level5() {

        walkingTextureAtlas = new TextureAtlas("blackbeak walk.txt");
        textureAtlas = new TextureAtlas("World1_Level5.txt");
        evolveSheet = new Texture(Gdx.files.internal("jimmy hits the slopes evolution.png"));

        jimmyName = "blackbeak";
        jimmyAttackName = "Blackbeak attack";
        jimmyAbsorbName = "blackbeak absorb";
        background = "pirate background";

        walkingAnimation = new Animation<TextureRegion>(0.3f, walkingTextureAtlas.getRegions());
        deathToll = 10;

        levelStatus = MapLevelStatus.level6;
